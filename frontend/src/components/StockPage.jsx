...
//   // // data backend se fetch hoga
//   // useEffect(() => {
//   //   // Fetch stock details
//   //   fetch(`http://localhost:8080/base/${id}`) // Replace with your backend URL
//   //     .then((response) => response.json())
//   //     .then((data) => setStockDetails(data))
//   //     .catch((error) => console.error("Error fetching stock details:", error));

//   //   // Fetch historical data (if available in your backend)
//   //   fetch(`http://localhost:8080/base/${id}/historical`) // Replace with your backend URL
//   //     .then((response) => response.json())
